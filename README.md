...
Well this time around we were given the task to complete the backend part of our previous project “porter.in” as we had already created the frontend part of the project.

During this unit we had fewer members to work with, however we learned a lot since then. We started working for the first 2 day we couldn’t figure out how to proceed and connect our frontend to our backend, after banging our head together for couple of our we together came with an idea and it worked.

Through the whole Construct week our bond and skill of working as a team and working together on a common goal has increased significantly. We are storing the data provided by the user on the frontend and we store it using MongoDB. This has been a wonderful experience and though the journey we got to know more about backend and how to implement it in a real world project.